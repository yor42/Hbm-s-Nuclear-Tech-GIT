...
public class RenderSRocket extends Render<EntityRocketHoming> {
	...
	private static final ResourceLocation texture = new ResourceLocation(Tags.MOD_ID + ":textures/models/projectiles/ModelSRocket.png");
	...
	public void doRender(EntityRocketHoming rocket, double x, double y, double z, float entityYaw, float partialTicks) {
		...
		if(rocket.getIsCritical())
			bindTexture(new ResourceLocation(Tags.MOD_ID + ":textures/models/projectiles/ModelSVTRocket.png"));
		else
			bindTexture(new ResourceLocation(Tags.MOD_ID + ":textures/models/projectiles/ModelSRocket.png"));
