...
public class RenderBombletZeta extends Render<EntityBombletZeta> {
	...
	private static final ResourceLocation objTesterModelRL = new ResourceLocation(/*"/assets/" + */Tags.MOD_ID, "models/bombletTheta.obj");
	...
	protected RenderBombletZeta(RenderManager renderManager) {
		...
		boyTexture = new ResourceLocation(Tags.MOD_ID, "textures/models/projectiles/bombletZetaTexture.png");
	}
	...
	public void doRender(EntityBombletZeta entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        bindTexture(new ResourceLocation(Tags.MOD_ID, "textures/models/projectiles/bombletZetaTexture.png"));
