...
public class RenderDecoBlock extends TileEntitySpecialRenderer<TileEntityDecoBlock> {
	...
	private static final ResourceLocation texture1 = new ResourceLocation(Tags.MOD_ID + ":" + "textures/models/deco/SteelWall.png");
	private static final ResourceLocation texture2 = new ResourceLocation(Tags.MOD_ID + ":" + "textures/models/deco/SteelCorner.png");
	private static final ResourceLocation texture3 = new ResourceLocation(Tags.MOD_ID + ":" + "textures/models/deco/SteelRoof.png");
