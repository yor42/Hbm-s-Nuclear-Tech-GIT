...
public class EntityMiniNuke extends Entity implements IProjectile {
	...
	public static final DataParameter<Boolean> CRITICAL = EntityDataManager.createKey(EntityMiniNuke.class, DataSerializers.BOOLEAN);
    ...
    public EntityMiniNuke(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_, EnumHand hand)
    {
        super(p_i1756_1_);
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                ...
                else
                {
                    ...
                    this.field_145790_g = newBlockState.getBlock();
                    this.inData = newBlockState.getBlock().getMetaFromState(newBlockState);
