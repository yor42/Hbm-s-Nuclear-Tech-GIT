...
public class EntitySchrab extends Entity implements IProjectile {
	...
	public static final DataParameter<Boolean> CRITICAL = EntityDataManager.createKey(EntitySchrab.class, DataSerializers.BOOLEAN);
	...
	public void onUpdate()
    {
        ...
        if (this.inGround)
        {
            ...
            this.world.spawnEntity(new EntityLightningBolt(this.world, this.posX, this.posY, this.posZ, true));
        	this.setDead();
        }
        else
        {
	...
	public void onCollideWithPlayer(EntityPlayer p_70100_1_)
    {
        if (!this.world.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (flag)
            {
                this.playSound(SoundEvents.BLOCK_LAVA_POP, 0.2F, ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.7F + 1.0F) * 2.0F);
