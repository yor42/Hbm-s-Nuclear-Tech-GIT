...
public class EntitySparkBeam extends Entity implements IProjectile {
    ...
    public EntitySparkBeam(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_, EnumHand hand)
    {
        super(p_i1756_1_);
        this.shootingEntity = p_i1756_2_;
	...
	public void onUpdate()
    {
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                ...
                {
                	IBlockState state1 = world.getBlockState(new BlockPos(this.field_145791_d, this.field_145792_e, this.field_145789_f));
                    ...
                    this.field_145790_g = state1.getBlock();
                    this.inData = state1.getBlock().getMetaFromState(state1);
                }
            }
    ...
    {
        this.getDataManager().set(CRITICAL, b);
    }
