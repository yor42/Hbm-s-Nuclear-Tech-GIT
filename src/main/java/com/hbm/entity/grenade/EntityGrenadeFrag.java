...
public class EntityGrenadeFrag extends EntityGrenadeBouncyBase
{
    ...
    public EntityGrenadeFrag(World p_i1774_1_, EntityLivingBase p_i1774_2_, EnumHand hand)
    {
    ...
    public void explode() {
        ...
        if (!this.world.isRemote)
        {
        	if(this.isBurning())
        	{
        		...
        		this.setDead();
        		ExplosionChaos.frag(this.world, (int)this.posX, (int)this.posY, (int)this.posZ, 100, false, this.shooter);
        		this.world.playSound(null, (int)this.posX, (int)this.posY, (int)this.posZ, SoundEvents.ENTITY_GENERIC_EXPLODE, SoundCategory.AMBIENT, 4.0F, (1.0F + (this.world.rand.nextFloat() - this.world.rand.nextFloat()) * 0.2F) * 0.7F);
        	}
        }
    }
