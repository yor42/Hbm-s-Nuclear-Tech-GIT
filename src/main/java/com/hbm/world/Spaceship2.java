...
public class Spaceship2
{
	...
	public boolean generate_r00(World world, Random rand, int x, int y, int z)
    {
		...
		world.setBlockState(pos.setPos(x + 10, y, z + 17), Blocks.AIR.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 10, y, z + 18), Blocks.AIR.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 10, y, z + 19), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 20), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 20), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 20), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 20), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 20), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 20), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 20), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 20), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 10, y, z + 20), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 21), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 21), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 21), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 21), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 21), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 21), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 21), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 21), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 10, y, z + 21), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 22), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 22), Blocks.AIR.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 10, y, z + 22), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 23), Blocks.AIR.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 5, y, z + 23), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 23), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 23), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 23), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 23), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 10, y, z + 23), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 24), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 24), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 24), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 24), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 24), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 24), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 24), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 24), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 10, y, z + 24), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 25), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 25), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 25), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 25), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 25), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 25), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 25), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 25), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 10, y, z + 25), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 26), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 26), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 26), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 26), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 26), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 26), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 26), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 26), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 10, y, z + 26), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 27), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 27), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 27), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 27), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 27), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 27), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 27), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 27), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 10, y, z + 27), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 28), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 28), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 28), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 28), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 28), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 28), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 28), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 28), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 10, y, z + 28), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 29), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 29), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 29), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 29), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 29), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 29), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 29), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 29), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 10, y, z + 29), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 30), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 30), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 30), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 30), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 30), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 30), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 30), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 30), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 10, y, z + 30), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 11, y, z + 30), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 31), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 31), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 31), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 31), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 31), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 31), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 31), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 10, y, z + 31), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 32), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 32), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 32), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 32), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 33), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 33), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 33), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 33), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 34), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 34), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 34), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 34), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 35), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 35), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 35), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 35), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 36), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 36), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 36), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 36), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 37), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 37), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 37), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 37), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 37), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 38), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 38), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 38), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 38), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 38), Block3.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 38), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 39), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 39), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 39), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 39), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 39), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 39), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 40), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 40), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 40), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 40), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 40), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 41), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 41), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 41), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 42), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 42), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 42), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 42), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 43), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 43), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 43), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 43), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 43), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 43), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 44), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 44), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 44), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 44), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 9, y, z + 44), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 5, y, z + 45), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 6, y, z + 45), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 7, y, z + 45), Blocks.AIR.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 8, y, z + 45), Blocks.AIR.getDefaultState(), 3);
