...
public class Barrel extends WorldGenerator {
	...
	public boolean generate_r0(World world, Random rand, int x, int y, int z, boolean force) {
		...
		world.setBlockState(pos.setPos(x + 1, y, z), Block2.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z), Block2.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 1, y, z + 1), Block4.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 1), Block5.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 1), Block4.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 1, y, z + 2), Block5.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 2), Block6.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 3, y, z + 2), Block5.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 2), Block2.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y, z + 3), Block2.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 1, y, z + 3), Block5.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 3), Block4.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 3), Block5.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y, z + 3), Block2.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 1, y, z + 4), Block2.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y, z + 4), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y, z + 4), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 1, y + 1, z), Block2.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 1, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 1, z), Block2.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 1, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 1, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		...
		{
			WeightedRandomChestContentFrom1710.generateChestContents(rand, HbmChestContents.getLoot(3), world.getTileEntity(pos.setPos(x + 2, y + 1, z + 2)), 16);
		}
		...
		world.setBlockState(pos.setPos(x, y + 1, z + 3), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 1, y + 2, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 2, z), Block2.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 2, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 2, z + 1), Block2.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 2, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 2, z + 3), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 1, y + 3, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 3, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 3, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 3, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 3, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 3, z + 3), Block2.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 1, y + 4, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 4, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 4, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 4, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 4, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 4, z + 3), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 1, y + 5, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 5, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 5, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 5, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 5, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 5, z + 3), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 1, y + 6, z), Block10.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 6, z), Block10.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 6, z), Block10.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 6, z + 1), Block10.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 6, z + 2), Block10.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 6, z + 3), Block10.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 1, y + 7, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 7, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 7, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 7, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 7, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 7, z + 3), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 1, y + 8, z), Block10.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 8, z), Block10.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 8, z), Block10.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 8, z + 1), Block10.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 8, z + 2), Block10.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 8, z + 3), Block10.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 1, y + 9, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 9, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 9, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 9, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y + 9, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 9, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y + 9, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 9, z + 3), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 1, y + 10, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 10, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 10, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 10, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y + 10, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 10, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y + 10, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 10, z + 3), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 1, y + 11, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 11, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 11, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 11, z + 1), Block11.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 11, z + 2), Block11.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y + 11, z + 2), Block11.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 11, z + 3), Block11.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 1, y + 12, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 12, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 12, z), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 12, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y + 12, z + 1), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 12, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 4, y + 12, z + 2), Library.getRandomConcrete().getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 12, z + 3), Library.getRandomConcrete().getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x + 1, y + 13, z), Block1.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 2, y + 13, z), Block1.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x + 3, y + 13, z), Block1.getDefaultState(), 3);
		world.setBlockState(pos.setPos(x, y + 13, z + 1), Block1.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 13, z + 2), Block1.getDefaultState(), 3);
		...
		world.setBlockState(pos.setPos(x, y + 13, z + 3), Block1.getDefaultState(), 3);
	...
	public boolean generate_r02_last(World world, Random rand, int x, int y, int z, MutableBlockPos pos) {
		...
		world.setBlockState(pos.setPos(x + 2, y, z + 5), Blocks.LADDER.getDefaultState().withProperty(BlockLadder.FACING, EnumFacing.SOUTH), 3);
