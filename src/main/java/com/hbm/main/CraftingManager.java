...
public class CraftingManager {
	...
	public static void addCrafting(){
		...
		addRecipeAuto(new ItemStack(ModItems.hazmat_cloth_grey, 1), "DPD", "ICI", "DLD", 'C', ModItems.hazmat_cloth_red, 'P', IRON.plate(), 'L', PB.plate(), 'I', ModItems.plate_polymer, 'D', I.dustTiny());
		...
		addRecipeAuto(new ItemStack(ModItems.plate_polymer, 8), "DD", 'D', POLYMER.ingot());
		addRecipeAuto(new ItemStack(ModItems.plate_polymer, 4), "SWS", 'S', Items.STRING, 'W', Blocks.WOOL);
		addRecipeAuto(new ItemStack(ModItems.plate_polymer, 4), "BB", 'B', Items.BRICK);
		...
		addRecipeAuto(new ItemStack(ModBlocks.block_radspice, 1), "###", "###", "###", '#', ModItems.ingot_radspice);
		...
		addShapelessAuto(new ItemStack(ModItems.ingot_uranium_fuel, 1), U235.nugget(), U235.nugget(), U235.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget());
		addShapelessAuto(new ItemStack(ModItems.ingot_uranium_fuel, 1), U233.nugget(), U233.nugget(), U233.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget());
		addShapelessAuto(new ItemStack(ModItems.ingot_thorium_fuel, 1), U233.nugget(), U233.nugget(), U233.nugget(), TH232.nugget(), TH232.nugget(), TH232.nugget(), TH232.nugget(), TH232.nugget(), TH232.nugget());
		...
		addShapelessAuto(new ItemStack(ModItems.ingot_mox_fuel, 1), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), PU239.nugget(), PU239.nugget(), PU239.nugget());
		addShapelessAuto(new ItemStack(ModItems.ingot_mox_fuel, 1), U235.nugget(), U235.nugget(), U235.nugget(), U238.nugget(), U238.nugget(), PU238.nugget(), PU239.nugget(), PU239.nugget(), PU239.nugget());
		...
		addShapelessAuto(new ItemStack(ModItems.ingot_les, 1), SA326.nugget(), NP237.nugget(), NP237.nugget(), NP237.nugget(), NP237.nugget(), BE.nugget(), BE.nugget(), BE.nugget(), BE.nugget());
		...
		addRecipeAuto(new ItemStack(ModItems.ingot_copper, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_copper));
		...
		addRecipeAuto(new ItemStack(ModItems.ingot_red_copper, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_red_copper));
		addRecipeAuto(new ItemStack(ModItems.ingot_steel, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_steel));
		addRecipeAuto(new ItemStack(ModItems.sulfur, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_sulfur));
		addRecipeAuto(new ItemStack(ModItems.ingot_titanium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_titanium));
		addRecipeAuto(new ItemStack(ModItems.ingot_tungsten, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_tungsten));
		addRecipeAuto(new ItemStack(ModItems.ingot_uranium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_uranium));
		addRecipeAuto(new ItemStack(ModItems.ingot_th232, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_thorium));
		addRecipeAuto(new ItemStack(ModItems.ingot_lead, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_lead));
		...
		addRecipeAuto(new ItemStack(ModItems.ingot_beryllium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_beryllium));
		addRecipeAuto(new ItemStack(ModItems.ingot_schrabidium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_schrabidium));
		addRecipeAuto(new ItemStack(ModItems.ingot_euphemium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_euphemium));
		addRecipeAuto(new ItemStack(ModItems.ingot_advanced_alloy, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_advanced_alloy));
		addRecipeAuto(new ItemStack(ModItems.ingot_magnetized_tungsten, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_magnetized_tungsten));
		addRecipeAuto(new ItemStack(ModItems.ingot_combine_steel, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_combine_steel));
		addRecipeAuto(new ItemStack(ModItems.ingot_australium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_australium));
		addRecipeAuto(new ItemStack(ModItems.ingot_weidanium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_weidanium));
		addRecipeAuto(new ItemStack(ModItems.ingot_reiium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_reiium));
		addRecipeAuto(new ItemStack(ModItems.ingot_unobtainium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_unobtainium));
		addRecipeAuto(new ItemStack(ModItems.ingot_daffergon, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_daffergon));
		addRecipeAuto(new ItemStack(ModItems.ingot_verticium, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_verticium));
		addRecipeAuto(new ItemStack(ModItems.ingot_desh, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_desh));
		addRecipeAuto(new ItemStack(ModItems.ingot_dura_steel, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_dura_steel));
		addRecipeAuto(new ItemStack(ModItems.ingot_saturnite, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_saturnite));
		addRecipeAuto(new ItemStack(ModItems.ingot_ra226, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_ra226));
		addRecipeAuto(new ItemStack(ModItems.ingot_radspice, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_radspice));
		addRecipeAuto(new ItemStack(ModItems.ingot_polymer, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_polymer));
		addRecipeAuto(new ItemStack(ModItems.ingot_bakelite, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_bakelite));
		addRecipeAuto(new ItemStack(ModItems.ingot_rubber, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_rubber));
		addRecipeAuto(new ItemStack(ModItems.powder_yellowcake, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_yellowcake));
		addRecipeAuto(new ItemStack(ModItems.ingot_au198, 9), "#", '#', Item.getItemFromBlock(ModBlocks.block_au198));
		addRecipeAuto(new ItemStack(ModItems.ingot_starmetal, 9), "#", '#', ModBlocks.block_starmetal);

		addRecipeAuto(new ItemStack(ModItems.ingot_plutonium, 1), "###", "###", "###", '#', PU.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_plutonium, 9), "#", '#', PU.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_pu238, 1), "###", "###", "###", '#', PU238.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_pu238, 9), "#", '#', PU238.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_pu239, 1), "###", "###", "###", '#', PU239.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_pu239, 9), "#", '#', PU239.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_pu240, 1), "###", "###", "###", '#', PU240.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_pu240, 9), "#", '#', PU240.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_th232, 1), "###", "###", "###", '#', TH232.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_th232, 9), "#", '#', TH232.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_uranium, 1), "###", "###", "###", '#', U.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_uranium, 9), "#", '#', U.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_u233, 1), "###", "###", "###", '#',U233.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_u233, 9), "#", '#',U233.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_u235, 1), "###", "###", "###", '#', U235.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_u235, 9), "#", '#', U235.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_u238, 1), "###", "###", "###", '#', U238.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_u238, 9), "#", '#', U238.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_neptunium, 1), "###", "###", "###", '#', NP237.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_neptunium, 9), "#", '#', NP237.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_polonium, 1), "###", "###", "###", '#', PO210.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_polonium, 9), "#", '#', PO210.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_lead, 1), "###", "###", "###", '#', PB.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_lead, 9), "#", '#', PB.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_beryllium, 1), "###", "###", "###", '#', BE.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_beryllium, 9), "#", '#', BE.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_schrabidium, 1), "###", "###", "###", '#', SA326.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_schrabidium, 9), "#", '#', SA326.ingot());
		...
		addRecipeAuto(new ItemStack(ModItems.ingot_australium, 1), "###", "###", "###", '#', AUSTRALIUM.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_australium, 9), "#", '#', AUSTRALIUM.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_weidanium, 1), "###", "###", "###", '#', WEIDANIUM.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_weidanium, 9), "#", '#', WEIDANIUM.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_reiium, 1), "###", "###", "###", '#', REIIUM.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_reiium, 9), "#", '#', REIIUM.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_unobtainium, 1), "###", "###", "###", '#', UNOBTAINIUM.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_unobtainium, 9), "#", '#', UNOBTAINIUM.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_daffergon, 1), "###", "###", "###", '#', DAFFERGON.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_daffergon, 9), "#", '#', DAFFERGON.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_verticium, 1), "###", "###", "###", '#', VERTICIUM.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_verticium, 9), "#", '#', VERTICIUM.ingot());

		addRecipeAuto(new ItemStack(ModItems.ingot_ac227, 1), "###", "###", "###", '#', AC227.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_ac227, 9), "#", '#', AC227.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_actinium, 1), "###", "###", "###", '#', AC.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_actinium, 9), "#", '#', AC.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_cobalt, 1), "###", "###", "###", '#', CO.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_cobalt, 9), "#", '#', CO.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_sr90, 1), "###", "###", "###", '#', SR90.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_sr90, 9), "#", '#', SR90.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_strontium, 1), "###", "###", "###", '#', SR.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_strontium, 9), "#", '#', SR.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_pb209, 1), "###", "###", "###", '#', PB209.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_pb209, 9), "#", '#', PB209.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_gh336, 1), "###", "###", "###", '#', GH336.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_gh336, 9), "#", '#', GH336.ingot());
		...
		addRecipeAuto(new ItemStack(ModItems.ingot_ra226, 1), "###", "###", "###", '#', RA226.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_ra226, 9), "#", '#', RA226.ingot());
		addRecipeAuto(new ItemStack(ModItems.ingot_desh, 1), "###", "###", "###", '#', DESH.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_desh, 9), "#", '#', DESH.ingot());

		addRecipeAuto(new ItemStack(ModItems.powder_radspice, 1), "ABC", "DEF", "HIJ", 'A', CO60.dust(), 'B', SR90.dust(), 'C', I131.dust(), 'D', CS137.dust(), 'E', XE135.dust(), 'F', AU198.dust(), 'H', PB209.dust(), 'I', AT209.dust(), 'J', AC227.dust());
		addRecipeAuto(new ItemStack(ModItems.powder_steel, 1), "###", "###", "###", '#', STEEL.dustTiny());
		addRecipeAuto(new ItemStack(ModItems.powder_steel_tiny, 9), "#", '#', STEEL.dust());
		addRecipeAuto(new ItemStack(ModItems.powder_lithium, 1), "###", "###", "###", '#', LI.dustTiny());
		addRecipeAuto(new ItemStack(ModItems.powder_lithium_tiny, 9), "#", '#', LI.dust());
		addRecipeAuto(new ItemStack(ModItems.powder_cobalt, 1), "###", "###", "###", '#', CO.dustTiny());
		addRecipeAuto(new ItemStack(ModItems.powder_cobalt_tiny, 9), "#", '#', CO.dust());
		addRecipeAuto(new ItemStack(ModItems.powder_neodymium, 1), "###", "###", "###", '#', ND.dustTiny());
		addRecipeAuto(new ItemStack(ModItems.powder_neodymium_tiny, 9), "#", '#', ND.dust());
		addRecipeAuto(new ItemStack(ModItems.powder_niobium, 1), "###", "###", "###", '#', NB.dustTiny());
		addRecipeAuto(new ItemStack(ModItems.powder_niobium_tiny, 9), "#", '#', NB.dust());
		addRecipeAuto(new ItemStack(ModItems.powder_cerium, 1), "###", "###", "###", '#', CE.dustTiny());
		addRecipeAuto(new ItemStack(ModItems.powder_cerium_tiny, 9), "#", '#', CE.dust());
		addRecipeAuto(new ItemStack(ModItems.powder_lanthanium, 1), "###", "###", "###", '#', LA.dustTiny());
		addRecipeAuto(new ItemStack(ModItems.powder_lanthanium_tiny, 9), "#", '#', LA.dust());
		addRecipeAuto(new ItemStack(ModItems.powder_actinium, 1), "###", "###", "###", '#', AC.dustTiny());
		addRecipeAuto(new ItemStack(ModItems.powder_actinium_tiny, 9), "#", '#', AC.dust());
		...
		addRecipeAuto(new ItemStack(ModItems.ingot_solinium, 1), "###", "###", "###", '#', SA327.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_solinium, 9), "#", '#', SA327.ingot());
		...
		addShapelessAuto(new ItemStack(ModItems.rod_th232, 1), ModItems.rod_empty, TH232.nugget(), TH232.nugget(), TH232.nugget(), TH232.nugget(), TH232.nugget(), TH232.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_uranium, 1), ModItems.rod_empty, U.nugget(), U.nugget(), U.nugget(), U.nugget(), U.nugget(), U.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_u233, 1), ModItems.rod_empty,U233.nugget(),U233.nugget(),U233.nugget(),U233.nugget(),U233.nugget(),U233.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_u235, 1), ModItems.rod_empty, U235.nugget(), U235.nugget(), U235.nugget(), U235.nugget(), U235.nugget(), U235.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_u238, 1), ModItems.rod_empty, U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_plutonium, 1), ModItems.rod_empty, PU.nugget(), PU.nugget(), PU.nugget(), PU.nugget(), PU.nugget(), PU.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_pu238, 1), ModItems.rod_empty, PU238.nugget(), PU238.nugget(), PU238.nugget(), PU238.nugget(), PU238.nugget(), PU238.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_pu239, 1), ModItems.rod_empty, PU239.nugget(), PU239.nugget(), PU239.nugget(), PU239.nugget(), PU239.nugget(), PU239.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_pu240, 1), ModItems.rod_empty, PU240.nugget(), PU240.nugget(), PU240.nugget(), PU240.nugget(), PU240.nugget(), PU240.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_neptunium, 1), ModItems.rod_empty, NP237.nugget(), NP237.nugget(), NP237.nugget(), NP237.nugget(), NP237.nugget(), NP237.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_polonium, 1), ModItems.rod_empty, PO210.nugget(), PO210.nugget(), PO210.nugget(), PO210.nugget(), PO210.nugget(), PO210.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_lead, 1), ModItems.rod_empty, PB.nugget(), PB.nugget(), PB.nugget(), PB.nugget(), PB.nugget(), PB.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_schrabidium, 1), ModItems.rod_empty, SA326.nugget(), SA326.nugget(), SA326.nugget(), SA326.nugget(), SA326.nugget(), SA326.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_solinium, 1), ModItems.rod_empty, SA327.nugget(), SA327.nugget(), SA327.nugget(), SA327.nugget(), SA327.nugget(), SA327.nugget());
		...
		addShapelessAuto(new ItemStack(ModItems.rod_euphemium, 1), ModItems.rod_empty, EUPH.nugget(), EUPH.nugget(), EUPH.nugget(), EUPH.nugget(), EUPH.nugget(), EUPH.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_australium, 1), ModItems.rod_empty, AUSTRALIUM.nugget(), AUSTRALIUM.nugget(), AUSTRALIUM.nugget(), AUSTRALIUM.nugget(), AUSTRALIUM.nugget(), AUSTRALIUM.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_weidanium, 1), ModItems.rod_empty, WEIDANIUM.nugget(), WEIDANIUM.nugget(), WEIDANIUM.nugget(), WEIDANIUM.nugget(), WEIDANIUM.nugget(), WEIDANIUM.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_reiium, 1), ModItems.rod_empty, REIIUM.nugget(), REIIUM.nugget(), REIIUM.nugget(), REIIUM.nugget(), REIIUM.nugget(), REIIUM.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_unobtainium, 1), ModItems.rod_empty, UNOBTAINIUM.nugget(), UNOBTAINIUM.nugget(), UNOBTAINIUM.nugget(), UNOBTAINIUM.nugget(), UNOBTAINIUM.nugget(), UNOBTAINIUM.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_daffergon, 1), ModItems.rod_empty, DAFFERGON.nugget(), DAFFERGON.nugget(), DAFFERGON.nugget(), DAFFERGON.nugget(), DAFFERGON.nugget(), DAFFERGON.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_verticium, 1), ModItems.rod_empty, VERTICIUM.nugget(), VERTICIUM.nugget(), VERTICIUM.nugget(), VERTICIUM.nugget(), VERTICIUM.nugget(), VERTICIUM.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_balefire, 1), ModItems.rod_empty, ModItems.egg_balefire_shard);

		addShapelessAuto(new ItemStack(ModItems.rod_ac227, 1), ModItems.rod_empty, AC227.nugget(), AC227.nugget(), AC227.nugget(), AC227.nugget(), AC227.nugget(), AC227.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_cobalt, 1), ModItems.rod_empty, CO.nugget(), CO.nugget(), CO.nugget(), CO.nugget(), CO.nugget(), CO.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_co60, 1), ModItems.rod_empty, CO60.nugget(), CO60.nugget(), CO60.nugget(), CO60.nugget(), CO60.nugget(), CO60.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_ra226, 1), ModItems.rod_empty, RA226.nugget(), RA226.nugget(), RA226.nugget(), RA226.nugget(), RA226.nugget(), RA226.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_rgp, 1), ModItems.rod_empty, PURG.nugget(), PURG.nugget(), PURG.nugget(), PURG.nugget(), PURG.nugget(), PURG.nugget());
		...
		addShapelessAuto(new ItemStack(ModItems.rod_dual_th232, 1), ModItems.rod_dual_empty, TH232.ingot(), TH232.nugget(), TH232.nugget(), TH232.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_uranium, 1), ModItems.rod_dual_empty, U.ingot(), U.nugget(), U.nugget(), U.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_u233, 1), ModItems.rod_dual_empty,U233.ingot(),U233.nugget(),U233.nugget(),U233.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_u235, 1), ModItems.rod_dual_empty, U235.ingot(), U235.nugget(), U235.nugget(), U235.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_u238, 1), ModItems.rod_dual_empty, U238.ingot(), U238.nugget(), U238.nugget(), U238.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_plutonium, 1), ModItems.rod_dual_empty, PU.ingot(), PU.nugget(), PU.nugget(), PU.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_pu238, 1), ModItems.rod_dual_empty, PU238.ingot(), PU238.nugget(), PU238.nugget(), PU238.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_pu239, 1), ModItems.rod_dual_empty, PU239.ingot(), PU239.nugget(), PU239.nugget(), PU239.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_pu240, 1), ModItems.rod_dual_empty, PU240.ingot(), PU240.nugget(), PU240.nugget(), PU240.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_neptunium, 1), ModItems.rod_dual_empty, NP237.ingot(), NP237.nugget(), NP237.nugget(), NP237.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_polonium, 1), ModItems.rod_dual_empty, PO210.ingot(), PO210.nugget(), PO210.nugget(), PO210.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_lead, 1), ModItems.rod_dual_empty, PB.ingot(), PB.nugget(), PB.nugget(), PB.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_schrabidium, 1), ModItems.rod_dual_empty, SA326.ingot(), SA326.nugget(), SA326.nugget(), SA326.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_solinium, 1), ModItems.rod_dual_empty, SA327.ingot(), SA327.nugget(), SA327.nugget(), SA327.nugget());
		...
		addShapelessAuto(new ItemStack(ModItems.rod_dual_ac227, 1), ModItems.rod_dual_empty, AC227.ingot(), AC227.nugget(), AC227.nugget(), AC227.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_cobalt, 1), ModItems.rod_dual_empty, CO.ingot(), CO.nugget(), CO.nugget(), CO.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_co60, 1), ModItems.rod_dual_empty, CO60.ingot(), CO60.nugget(), CO60.nugget(), CO60.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_ra226, 1), ModItems.rod_dual_empty, RA226.ingot(), RA226.nugget(), RA226.nugget(), RA226.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_dual_rgp, 1), ModItems.rod_dual_empty, PURG.ingot(), PURG.nugget(), PURG.nugget(), PURG.nugget());
		...
		addShapelessAuto(new ItemStack(ModItems.rod_quad_th232, 1), ModItems.rod_quad_empty, TH232.ingot(), TH232.ingot(), TH232.nugget(), TH232.nugget(), TH232.nugget(), TH232.nugget(), TH232.nugget(), TH232.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_uranium, 1), ModItems.rod_quad_empty, U.ingot(), U.ingot(), U.nugget(), U.nugget(), U.nugget(), U.nugget(), U.nugget(), U.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_u233, 1), ModItems.rod_quad_empty,U233.ingot(),U233.ingot(),U233.nugget(),U233.nugget(),U233.nugget(),U233.nugget(),U233.nugget(),U233.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_u235, 1), ModItems.rod_quad_empty, U235.ingot(), U235.ingot(), U235.nugget(), U235.nugget(), U235.nugget(), U235.nugget(), U235.nugget(), U235.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_u238, 1), ModItems.rod_quad_empty, U238.ingot(), U238.ingot(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_plutonium, 1), ModItems.rod_quad_empty, PU.ingot(), PU.ingot(), PU.nugget(), PU.nugget(), PU.nugget(), PU.nugget(), PU.nugget(), PU.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_pu238, 1), ModItems.rod_quad_empty, PU238.ingot(), PU238.ingot(), PU238.nugget(), PU238.nugget(), PU238.nugget(), PU238.nugget(), PU238.nugget(), PU238.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_pu239, 1), ModItems.rod_quad_empty, PU239.ingot(), PU239.ingot(), PU239.nugget(), PU239.nugget(), PU239.nugget(), PU239.nugget(), PU239.nugget(), PU239.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_pu240, 1), ModItems.rod_quad_empty, PU240.ingot(), PU240.ingot(), PU240.nugget(), PU240.nugget(), PU240.nugget(), PU240.nugget(), PU240.nugget(), PU240.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_neptunium, 1), ModItems.rod_quad_empty, NP237.ingot(), NP237.ingot(), NP237.nugget(), NP237.nugget(), NP237.nugget(), NP237.nugget(), NP237.nugget(), NP237.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_polonium, 1), ModItems.rod_quad_empty, PO210.ingot(), PO210.ingot(), PO210.nugget(), PO210.nugget(), PO210.nugget(), PO210.nugget(), PO210.nugget(), PO210.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_lead, 1), ModItems.rod_quad_empty, PB.ingot(), PB.ingot(), PB.nugget(), PB.nugget(), PB.nugget(), PB.nugget(), PB.nugget(), PB.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_schrabidium, 1), ModItems.rod_quad_empty, SA326.ingot(), SA326.ingot(), SA326.nugget(), SA326.nugget(), SA326.nugget(), SA326.nugget(), SA326.nugget(), SA326.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_solinium, 1), ModItems.rod_quad_empty, SA327.ingot(), SA327.ingot(), SA327.nugget(), SA327.nugget(), SA327.nugget(), SA327.nugget(), SA327.nugget(), SA327.nugget());
		...
		addShapelessAuto(new ItemStack(ModItems.rod_quad_ac227, 1), ModItems.rod_quad_empty, AC227.ingot(), AC227.ingot(), AC227.nugget(), AC227.nugget(), AC227.nugget(), AC227.nugget(), AC227.nugget(), AC227.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_cobalt, 1), ModItems.rod_quad_empty, CO.ingot(), CO.ingot(), CO.nugget(), CO.nugget(), CO.nugget(), CO.nugget(), CO.nugget(), CO.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_co60, 1), ModItems.rod_quad_empty, CO60.ingot(), CO60.ingot(), CO60.nugget(), CO60.nugget(), CO60.nugget(), CO60.nugget(), CO60.nugget(), CO60.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_ra226, 1), ModItems.rod_quad_empty, RA226.ingot(), RA226.ingot(), RA226.nugget(), RA226.nugget(), RA226.nugget(), RA226.nugget(), RA226.nugget(), RA226.nugget());
		addShapelessAuto(new ItemStack(ModItems.rod_quad_rgp, 1), ModItems.rod_quad_empty, PURG.ingot(), PURG.ingot(), PURG.nugget(), PURG.nugget(), PURG.nugget(), PURG.nugget(), PURG.nugget(), PURG.nugget());
		...
		addRecipeAuto(new ItemStack(ModItems.ingot_euphemium, 1), "###", "###", "###", '#', EUPH.nugget());
		addRecipeAuto(new ItemStack(ModItems.nugget_euphemium, 9), "#", '#', EUPH.ingot());
		...
		addRecipeAuto(new ItemStack(ModBlocks.machine_siren, 1), "SIS", "ICI", "SRS", 'S', STEEL.plate(), 'I', ModItems.plate_polymer, 'C', ModItems.circuit_copper, 'R', REDSTONE.dust());
		...
		addRecipeAuto(new ItemStack(ModBlocks.muffler, 1), "III", "IWI", "III", 'I', ModItems.plate_polymer, 'W', Blocks.WOOL);
		...
		addRecipeAuto(ItemBombCaller.getStack(EnumCallerType.ATOMIC), "TRT", 'T', ModItems.gun_fatman_ammo, 'R', ModItems.detonator_laser);
		...
		addRecipeAuto(new ItemStack(ModItems.crystal_energy, 1), "EEE", "EGE", "EEE", 'E', ModItems.powder_power, 'G', Items.GLOWSTONE_DUST);
		addRecipeAuto(new ItemStack(ModItems.pellet_coolant, 1), "CRC", "RBR", "CRC", 'C', ModItems.powder_ice, 'R', ModItems.rod_quad_coolant, 'B', KNO.block());
		...
		addRecipeAuto(new ItemStack(ModItems.laser_crystal_dem, 1), "QDQ", "SBS", "QDQ", 'Q', ModBlocks.glass_quartz, 'D', CMB.ingot(), 'B', ModItems.demon_core_closed, 'S', GH336.nugget());
		...
		addRecipeAuto(new ItemStack(ModItems.mechanism_revolver_1, 1), " II", "ICA", "IKW", 'I', IRON.plate(), 'C', CU.ingot(), 'A', AL.ingot(), 'K', ModItems.wire_copper, 'W', ModItems.wire_aluminium);
		addRecipeAuto(new ItemStack(ModItems.mechanism_revolver_2, 1), " II", "ICA", "IKW", 'I', ALLOY.plate(), 'C', DURA.ingot(), 'A', W.ingot(), 'K', ModItems.bolt_dura_steel, 'W', ModItems.bolt_tungsten);
		...
		addRecipeAuto(new ItemStack(ModItems.mechanism_launcher_1, 1), "TTT", "SSS", "BBI", 'T', TI.plate(), 'S', STEEL.ingot(), 'B', ModItems.bolt_tungsten, 'I', MINGRADE.ingot());
		addRecipeAuto(new ItemStack(ModItems.mechanism_launcher_2, 1), "TTT", "SSS", "BBI", 'T', ALLOY.plate(), 'S', ANY_PLASTIC.ingot(), 'B', ModItems.bolt_dura_steel, 'I', DESH.ingot());
		...
		addRecipeAuto(new ItemStack(ModBlocks.brick_light, 4), "FBF", "BFB", "FBF", 'F', Blocks.OAK_FENCE, 'B', Blocks.BRICK_BLOCK);
		...
		addRecipeAuto(new ItemStack(ModBlocks.reinforced_glass, 8), "FBF", "BFB", "FBF", 'F', Blocks.IRON_BARS, 'B', Blocks.GLASS);
		addRecipeAuto(new ItemStack(ModBlocks.reinforced_light, 1), "FFF", "FBF", "FFF", 'F', Blocks.IRON_BARS, 'B', Blocks.GLOWSTONE);
		...
		addRecipeAuto(new ItemStack(ModItems.gun_hk69, 1), "SSI", " MB", 'S', ModItems.hull_small_steel, 'I', IRON.ingot(), 'M', ModItems.mechanism_launcher_1, 'B', ModItems.bolt_tungsten);
		addRecipeAuto(new ItemStack(ModItems.gun_stinger, 1), "SSW", "CMW", 'S', STEEL.plate(), 'W', TI.plate(), 'C', ModItems.circuit_red_copper, 'M', ModItems.mechanism_launcher_2);
		...
		addRecipeAuto(new ItemStack(ModItems.gun_revolver, 1), "SSM", " RW", 'S', STEEL.plate(), 'W', KEY_PLANKS, 'R', ModItems.wire_aluminium, 'M', ModItems.mechanism_revolver_1);
		addRecipeAuto(new ItemStack(ModItems.gun_revolver_saturnite, 1), "SSM", " RW", 'S', BIGMT.plate(), 'W', KEY_PLANKS, 'R', ModItems.wire_tungsten, 'M', ModItems.mechanism_revolver_2);
		addRecipeAuto(new ItemStack(ModItems.gun_revolver_iron, 1), "SSM", " RW", 'S', IRON.plate(), 'W', KEY_PLANKS, 'R', ModItems.wire_aluminium, 'M', ModItems.mechanism_revolver_1);
		addRecipeAuto(new ItemStack(ModItems.gun_revolver_gold, 1), "SSM", " RW", 'S', GOLD.plate(), 'W', GOLD.ingot(), 'R', ModItems.wire_gold, 'M', ModItems.mechanism_revolver_1);
		addRecipeAuto(new ItemStack(ModItems.gun_revolver_lead, 1), "SSM", " RW", 'S', PB.plate(), 'W', W.ingot(), 'R', ModItems.wire_tungsten, 'M', ModItems.mechanism_revolver_2);
		addRecipeAuto(new ItemStack(ModItems.gun_revolver_schrabidium, 1), "SSM", " RW", 'S', SA326.block(), 'W', W.ingot(), 'R', ModItems.wire_schrabidium, 'M', ModItems.mechanism_special);
		addRecipeAuto(new ItemStack(ModItems.gun_deagle, 1), "PPM", " BI", 'P', STEEL.plate(), 'B', ModItems.bolt_tungsten, 'I', ANY_PLASTIC.ingot(), 'M', ModItems.mechanism_rifle_1);
		addRecipeAuto(new ItemStack(ModItems.gun_revolver_cursed, 1), "TTM", "SRI", 'S', STEEL.plate(), 'I', STEEL.ingot(), 'R', ModItems.wire_red_copper, 'T', TI.plate(), 'M', ModItems.mechanism_revolver_2);
		addRecipeAuto(new ItemStack(ModItems.gun_revolver_nightmare, 1), "SEM", " RW", 'S', STEEL.plate(), 'W', KEY_PLANKS, 'R', ModItems.wire_aluminium, 'E', ModItems.powder_power, 'M', ModItems.mechanism_revolver_2);
		addRecipeAuto(new ItemStack(ModItems.gun_revolver_nightmare2, 1), "SSM", "RRW", 'S', OreDictManager.getReflector(), 'W', W.ingot(), 'R', ModItems.wire_gold, 'M', ModItems.mechanism_special);
		addRecipeAuto(new ItemStack(ModItems.gun_fatman, 1), "SSI", "IIM", "WPH", 'S', STEEL.plate(), 'I', STEEL.ingot(), 'W', ModItems.wire_aluminium, 'H', ModItems.hull_small_steel, 'P', Item.getItemFromBlock(Blocks.PISTON), 'M', ModItems.mechanism_launcher_2);

		addRecipeAuto(new ItemStack(ModItems.gun_mirv, 1), "LLL", "WFW", "SSS", 'S', STEEL.plate(), 'L', PB.plate(), 'W', ModItems.wire_gold, 'F', ModItems.gun_fatman);
		...
		addRecipeAuto(new ItemStack(ModItems.gun_osipr, 1), "CCT", "WWI", "MCC", 'C', CMB.plate(), 'T', W.ingot(), 'W', ModItems.wire_magnetized_tungsten, 'I', ModItems.mechanism_rifle_2, 'M', ModItems.coil_magnetized_tungsten);
		addRecipeAuto(new ItemStack(ModItems.gun_immolator, 1), "WCC", "PMT", "WAA", 'W', ModItems.wire_gold, 'C', CU.plate(), 'P', ALLOY.plate(), 'M', ModItems.mechanism_launcher_1, 'T', ModItems.tank_steel, 'A', STEEL.plate());
		addRecipeAuto(new ItemStack(ModItems.gun_immolator_ammo, 16), "SPS", "PCP", "SPS", 'S', STEEL.plate(), 'C', COAL.dust(), 'P',P_RED.dust());
		addRecipeAuto(new ItemStack(ModItems.gun_immolator_ammo, 16), " F ", "SFS", " F ", 'S', STEEL.plate(), 'F', new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.diesel)));
		addRecipeAuto(new ItemStack(ModItems.gun_immolator_ammo, 16), " F ", "SFS", " F ", 'S', STEEL.plate(), 'F', new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.kerosene)));
		addRecipeAuto(new ItemStack(ModItems.gun_immolator_ammo, 24), " F ", "SFS", " F ", 'S', STEEL.plate(), 'F', ModItems.canister_napalm);
		addRecipeAuto(new ItemStack(ModItems.gun_immolator_ammo, 32), " F ", "SFS", " F ", 'S', STEEL.plate(), 'F', new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.nitan)));
		addRecipeAuto(new ItemStack(ModItems.gun_cryolator, 1), "SSS", "IWL", "LMI", 'S', STEEL.plate(), 'I', IRON.plate(), 'L', Items.LEATHER, 'M', ModItems.mechanism_launcher_1, 'W', ModItems.wire_aluminium);
		...
		addRecipeAuto(new ItemStack(ModItems.gun_emp, 1), "CPG", "CMF", "CPI", 'C', ModItems.coil_copper, 'P', PB.plate(), 'G', ModItems.circuit_gold, 'M', ModItems.magnetron, 'I', W.ingot(), 'F', ModItems.mechanism_special);
		...
		addRecipeAuto(new ItemStack(ModItems.gun_lever_action, 1), "PPI", "SWD", 'P', IRON.plate(), 'I', ModItems.mechanism_rifle_1, 'S', Items.STICK, 'D', KEY_PLANKS, 'W', ModItems.wire_aluminium);
		addRecipeAuto(new ItemStack(ModItems.gun_lever_action_dark, 1), "PPI", "SWD", 'P', STEEL.plate(), 'I', ModItems.mechanism_rifle_1, 'S', Items.STICK, 'D', KEY_PLANKS, 'W', ModItems.wire_aluminium);
		addRecipeAuto(new ItemStack(ModItems.gun_bolt_action, 1), "PPI", "SWD", 'P', STEEL.plate(), 'I', ModItems.mechanism_rifle_1, 'S', Items.STICK, 'D', KEY_PLANKS, 'W', ModItems.wire_copper);
		addRecipeAuto(new ItemStack(ModItems.gun_bolt_action_green, 1), "PPI", "SWD", 'P', IRON.plate(), 'I', ModItems.mechanism_rifle_1, 'S', Items.STICK, 'D', KEY_PLANKS, 'W', ModItems.wire_copper);
		addRecipeAuto(new ItemStack(ModItems.gun_bolt_action_saturnite, 1), "PPI", "SWD", 'P', BIGMT.plate(), 'I', ModItems.mechanism_rifle_1, 'S', Items.STICK, 'D', KEY_PLANKS, 'W', ModItems.wire_tungsten);
		addRecipeAuto(new ItemStack(ModItems.gun_b92, 1), "DDD", "SSC", "  R", 'D', ModItems.plate_dineutronium, 'S', STAR.ingot(), 'C', ModItems.circuit_targeting_tier6, 'R', ModItems.gun_revolver_schrabidium);
		...
		addRecipeAuto(new ItemStack(ModItems.gun_uzi, 1), "SMS", " PB", " P ", 'S', STEEL.ingot(), 'M', ModItems.mechanism_rifle_2, 'P', STEEL.plate(), 'B', ModItems.bolt_dura_steel);
		addRecipeAuto(new ItemStack(ModItems.gun_uzi_silencer, 1), "P  ", " P ", "  U", 'P', ANY_PLASTIC.ingot(), 'U', ModItems.gun_uzi);
		addRecipeAuto(new ItemStack(ModItems.gun_uzi_saturnite, 1), "SMS", " PB", " P ", 'S', BIGMT.ingot(), 'M', ModItems.mechanism_rifle_2, 'P', BIGMT.plate(), 'B', ModItems.bolt_tungsten);
		...
		addRecipeAuto(new ItemStack(ModItems.gun_vortex, 1), "AS ", "SIP", " SC", 'S', ModItems.plate_armor_lunar, 'I', ModItems.gun_xvl1456, 'A', ModItems.levitation_unit, 'P', ModItems.circuit_tantalium, 'C', ModItems.crystal_trixite);
	...
	public static void reg2(){
		...
		addRecipeAuto(new ItemStack(ModItems.assembly_schrabidium, 6), " I ", "GCN", " P ", 'I', SA326.ingot(), 'G', ModItems.cordite, 'C', ModItems.casing_357, 'P', ModItems.primer_357, 'N', Items.NETHER_STAR);
		...
		addRecipeAuto(new ItemStack(ModItems.ammo_12gauge, 12), " I ", "GCL", " P ", 'I', ModItems.pellet_buckshot, 'G', ANY_SMOKELESS.dust(), 'C', ModItems.casing_buckshot, 'P', ModItems.primer_buckshot, 'L', ModItems.plate_polymer);
		...
		addRecipeAuto(new ItemStack(ModItems.ammo_dart, 16), "IPI", "ICI", "IPI", 'I', ModItems.plate_polymer, 'P', IRON.plate(), 'C', new IngredientContainsTag(ItemFluidTank.getFullBarrel(ModForgeFluids.watz)));
		...
		addRecipeAuto(new ItemStack(ModItems.folly_bullet_nuclear, 1), " N ", "UTU", "UTU", 'N', ModItems.gun_fatman_ammo, 'U', IRON.ingot(), 'T', W.block());
		...
		addRecipeAuto(new ItemStack(ModItems.ammo_rocket_rpc, 2), "BP ", "CBH", " DR", 'B', ModItems.blades_steel, 'P', STEEL.plate(), 'C', new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.diesel)), 'H', ModItems.hull_small_steel, 'D', ModItems.piston_selenium, 'R', ModItems.ammo_rocket);
		addRecipeAuto(new ItemStack(ModItems.ammo_rocket_rpc, 2), "BP ", "CBH", " DR", 'B', ModItems.blades_steel, 'P', STEEL.plate(), 'C', new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.petroil)), 'H', ModItems.hull_small_steel, 'D', ModItems.piston_selenium, 'R', ModItems.ammo_rocket);
		addRecipeAuto(new ItemStack(ModItems.ammo_rocket_rpc, 2), "BP ", "CBH", " DR", 'B', ModItems.blades_steel, 'P', STEEL.plate(), 'C', new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.biofuel)), 'H', ModItems.hull_small_steel, 'D', ModItems.piston_selenium, 'R', ModItems.ammo_rocket);
		addRecipeAuto(new ItemStack(ModItems.ammo_rocket_sleek, 64), "GGG", "GRG", "GGG", 'G', ModItems.ammo_rocket, 'R', ModItems.coin_maskman);

		addRecipeAuto(new ItemStack(ModItems.ammo_grenade, 2), " T ", "GCI", " P ", 'T', Items.GUNPOWDER, 'G', ANY_SMOKELESS.dust(), 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'I', IRON.plate());
		...
		addRecipeAuto(new ItemStack(ModItems.casing_357, 1), " P ", "   ", "P P", 'P', CU.plate());
		addRecipeAuto(new ItemStack(ModItems.casing_44, 1), "P", " ", "P", 'P', CU.plate());
		addRecipeAuto(new ItemStack(ModItems.casing_9, 1), "P", "P", 'P', CU.plate());
		addRecipeAuto(new ItemStack(ModItems.casing_50, 1), " P ", " P ", "PPP", 'P', CU.plate());
		addRecipeAuto(new ItemStack(ModItems.casing_buckshot, 1), "P P", "PPP", 'P', CU.plate());
		addRecipeAuto(new ItemStack(ModItems.casing_357, 1), " P ", "   ", "P P", 'P', IRON.plate());
		addRecipeAuto(new ItemStack(ModItems.casing_44, 1), "P", " ", "P", 'P', IRON.plate());
		addRecipeAuto(new ItemStack(ModItems.casing_9, 1), "P", "P", 'P', IRON.plate());
		addRecipeAuto(new ItemStack(ModItems.casing_50, 1), " P ", " P ", "PPP", 'P', IRON.plate());
		addRecipeAuto(new ItemStack(ModItems.casing_buckshot, 1), "P P", "PPP", 'P', IRON.plate());
		...
		addRecipeAuto(new ItemStack(ModItems.turret_spitfire_ammo, 1), "CP ", "PTP", " PR", 'P', STEEL.plate(), 'C', ModItems.circuit_copper, 'T', Blocks.TNT, 'R', REDSTONE.dust());
		...
		addRecipeAuto(new ItemStack(ModItems.grenade_generic, 4), "RS ", "ITI", " I ", 'I', IRON.plate(), 'R', ModItems.wire_red_copper, 'S', STEEL.plate(), 'T', Item.getItemFromBlock(Blocks.TNT));
		...
		addRecipeAuto(new ItemStack(ModItems.grenade_aschrab, 1), "RS ", "ITI", " S ", 'I', "paneGlassColorless", 'R', ModItems.wire_red_copper, 'S', STEEL.plate(), 'T', new IngredientContainsTag(ItemCell.getFullCell(ModForgeFluids.aschrab)));
		addRecipeAuto(new ItemStack(ModItems.grenade_mk2, 2), " G ", "SGS", " S ", 'G', ModItems.grenade_strong, 'S', Items.GUNPOWDER);
		addShapelessAuto(new ItemStack(ModItems.grenade_gascan, 1), new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.diesel)), Items.FLINT);
		addShapelessAuto(new ItemStack(ModItems.grenade_gascan, 1), new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.biofuel)), Items.FLINT);
		addShapelessAuto(new ItemStack(ModItems.grenade_gascan, 1), new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.petroil)), Items.FLINT);
		addShapelessAuto(new ItemStack(ModItems.grenade_gascan, 1), new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.kerosene)), Items.FLINT);
		...
		addShapelessAuto(new ItemStack(ModItems.pancake, 1), REDSTONE.dust(), DIAMOND.dust(), Items.WHEAT, ModItems.bolt_tungsten, ModItems.wire_copper, STEEL.plate());
		addShapelessAuto(new ItemStack(ModItems.pancake, 1), REDSTONE.dust(), EMERALD.dust(), Items.WHEAT, ModItems.bolt_tungsten, ModItems.wire_copper, STEEL.plate());
		...
		addShapelessAuto(new ItemStack(ModItems.can_creature, 1), ModItems.can_empty, Items.POTIONITEM, Items.SUGAR, new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.diesel)));
		...
		addRecipeAuto(new ItemStack(ModItems.syringe_metal_super, 1), " N ", "PSP", "L L", 'N', ModItems.bottle_nuka, 'P', STEEL.plate(), 'S', ModItems.syringe_metal_stimpak, 'L', ModItems.plate_polymer);
		...
		addRecipeAuto(new ItemStack(ModItems.syringe_metal_super, 1), " N ", "PSP", "L L", 'N', ModItems.bottle_cherry, 'P', STEEL.plate(), 'S', ModItems.syringe_metal_stimpak, 'L', ModItems.plate_polymer);
		addRecipeAuto(new ItemStack(ModItems.iv_empty, 4), "A", "B", "A", 'A', ModItems.plate_polymer, 'B', IRON.plate());
		...
		addShapelessAuto(new ItemStack(ModItems.powder_poison, 4), Items.SPIDER_EYE, REDSTONE.dust(), "gemQuartz");
		...
		addRecipeAuto(new ItemStack(ModItems.custom_tnt, 1), " C ", "TIT", "TIT", 'C', CU.plate(), 'I', IRON.plate(), 'T', Blocks.TNT);
		...
		addRecipeAuto(ItemBattery.getEmptyBattery(ModItems.battery_steam), "PMP", "ISI", "PCP", 'P', CU.plate(), 'M', ModItems.motor, 'C', ModItems.coil_tungsten, 'S', new IngredientContainsTag(ItemFluidTank.getFullTank(FluidRegistry.WATER)), 'I', ModItems.plate_polymer);
		...
		if(GeneralConfig.enableBabyMode) {
			...
			addRecipeAuto(new ItemStack(ModItems.schrabidium_sword, 1), "I", "W", "S", 'I', SA326.block(), 'W', ModItems.desh_sword, 'S', POLYMER.ingot());
		...
		addRecipeAuto(new ItemStack(ModItems.elec_sword, 1), "RPR", "RPR", " B ", 'P', POLYMER.ingot(), 'R', ModItems.bolt_dura_steel, 'B', ModItems.battery_lithium);
		addRecipeAuto(new ItemStack(ModItems.elec_pickaxe, 1), "RDM", " PB", " P ", 'P', POLYMER.ingot(), 'D', DURA.ingot(), 'R', ModItems.bolt_dura_steel, 'M', ModItems.motor, 'B', ModItems.battery_lithium);
		addRecipeAuto(new ItemStack(ModItems.elec_axe, 1), " DP", "RRM", " PB", 'P', POLYMER.ingot(), 'D', DURA.ingot(), 'R', ModItems.bolt_dura_steel, 'M', ModItems.motor, 'B', ModItems.battery_lithium);
		addRecipeAuto(new ItemStack(ModItems.elec_shovel, 1), "  P", "RRM", "  B", 'P', POLYMER.ingot(), 'R', ModItems.bolt_dura_steel, 'M', ModItems.motor, 'B', ModItems.battery_lithium);
		...
		addRecipeAuto(new ItemStack(ModItems.gas_mask_m65, 1), "PPP", "GPG", " F ", 'G', KEY_ANYPANE, 'P', ModItems.plate_polymer, 'F', IRON.plate());
		addRecipeAuto(new ItemStack(ModItems.gas_mask_mono, 1), " P ", "PPP", " F ", 'P', ModItems.plate_polymer, 'F', IRON.plate());
		...
		addRecipeAuto(new ItemStack(ModItems.gun_kit_1, 4), "I ", "LB", "P ", 'I', ModItems.plate_polymer, 'L', new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.lubricant)), 'B', ModItems.bolt_tungsten, 'P', IRON.plate());
		addRecipeAuto(new ItemStack(ModItems.gun_kit_2, 1), "III", "GLG", "PPP", 'I', ModItems.plate_polymer, 'L', ModItems.ducttape, 'G', ModItems.gun_kit_1, 'P', IRON.plate());
		...
		addRecipeAuto(new ItemStack(ModItems.turret_chip, 1), "WWW", "CPC", "WWW", 'W', ModItems.wire_gold, 'P', ANY_PLASTIC.ingot(), 'C', ModItems.circuit_gold);
		addRecipeAuto(new ItemStack(ModItems.turret_biometry, 1), "CC ", "GGS", "SSS", 'C', ModItems.circuit_copper, 'S', STEEL.plate(), 'G', GOLD.plate());
		...
		addShapelessAuto(new ItemStack(ModItems.powder_semtex_mix, 3), ModItems.solid_fuel, ModItems.cordite, KNO.dust());
		...
		addShapelessAuto(new ItemStack(ModItems.powder_red_copper, 2), REDSTONE.dust(), CU.dust());
		addShapelessAuto(new ItemStack(ModItems.powder_steel, 2), IRON.dust(), COAL.dust());
		...
		addRecipeAuto(new ItemStack(ModItems.turret_control, 1), "R12", "PPI", "  I", 'R', Items.REDSTONE, '1', ModItems.circuit_aluminium, '2', ModItems.circuit_red_copper, 'P', STEEL.plate(), 'I', STEEL.ingot());
		...
		addShapelessAuto(new ItemStack(ModItems.powder_desh_mix, 1), AC.dustTiny(), AC.dustTiny(), LA.dustTiny(), LA.dustTiny(), CE.dustTiny(), CO.dustTiny(), LI.dustTiny(), ND.dustTiny(), NB.dustTiny());
		addShapelessAuto(new ItemStack(ModItems.powder_desh_mix, 9), AC.dust(), AC.dust(), LA.dust(), LA.dust(), CE.dust(), CO.dust(), LI.dust(), ND.dust(), NB.dust());
		...
		addRecipeAuto(new ItemStack(ModItems.gun_revolver_pip, 1), " G ", "SSP", " TI", 'G', KEY_ANYPANE, 'S', STEEL.plate(), 'P', ModItems.mechanism_revolver_2, 'T', ModItems.wire_tungsten, 'I', ANY_PLASTIC.ingot());
		addRecipeAuto(new ItemStack(ModItems.gun_revolver_nopip, 1), "SSP", " TI", 'S', STEEL.plate(), 'P', ModItems.mechanism_revolver_2, 'T', ModItems.wire_tungsten, 'I', ANY_PLASTIC.ingot());
		addRecipeAuto(new ItemStack(ModItems.gun_revolver_silver, 1), "SSP", " TI", 'S', AL.plate(), 'P', ModItems.mechanism_revolver_2, 'T', ModItems.wire_tungsten, 'I', KEY_PLANKS);
		addRecipeAuto(new ItemStack(ModItems.gun_revolver_blackjack, 1), "SSP", " TI", 'S', STEEL.plate(), 'P', ModItems.mechanism_revolver_2, 'T', ModItems.wire_tungsten, 'I', KEY_PLANKS);
		...
		addRecipeAuto(new ItemStack(ModItems.jackt), "S S", "LIL", "LIL", 'S', STEEL.plate(), 'L', Items.LEATHER, 'I', ModItems.plate_polymer);
		addRecipeAuto(new ItemStack(ModItems.jackt2), "S S", "LIL", "III", 'S', STEEL.plate(), 'L', Items.LEATHER, 'I', ModItems.plate_polymer);
		addRecipeAuto(new ItemStack(ModItems.grenade_cloud), "SPS", "CAC", "SPS", 'S', S.dust(), 'P', ModItems.powder_poison, 'C', CU.dust(), 'A', new IngredientContainsTag(ItemFluidTank.getFullTank(ModForgeFluids.acid)));
		...
		addRecipeAuto(new ItemStack(ModBlocks.mine_he, 1), " C ", "PTP", 'C', ModItems.circuit_targeting_tier2, 'P', STEEL.plate(), 'T', ANY_PLASTICEXPLOSIVE.ingot());
		...
		addRecipeAuto(new ItemStack(ModItems.custom_fall, 1), "IIP", "CHW", "IIP", 'I', ModItems.plate_polymer, 'P', BIGMT.plate(), 'C', ModItems.circuit_red_copper, 'H', ModItems.hull_small_steel, 'W', ModItems.coil_copper);
		...
		addRecipeAuto(new ItemStack(ModItems.mp_warhead_15_boxcar, 1), "SNS", "CBC", "SFS", 'S', STAR.ingot(), 'N', ModBlocks.det_nuke, 'C', ModItems.circuit_targeting_tier4, 'B', ModBlocks.boxcar, 'F', ModItems.tritium_deuterium_cake);
		...
		addRecipeAuto(new ItemStack(ModItems.rune_blank, 1), "PSP", "SDS", "PSP", 'P', ModItems.powder_magic, 'S', STAR.ingot(), 'D', KEY_CIRCUIT_BISMUTH);
		...
		addRecipeAuto(new ItemStack(ModBlocks.dfc_core, 1), "DLD", "LML", "DLD", 'D', ModItems.ingot_bismuth, 'L', DNT.block(), 'M', KEY_CIRCUIT_BISMUTH);
		...
		addRecipeAuto(new ItemStack(ModItems.ingot_u233, 9), "#", '#', U233.block());
		addRecipeAuto(new ItemStack(ModItems.ingot_u235, 9), "#", '#', U235.block());
		addRecipeAuto(new ItemStack(ModItems.ingot_u238, 9), "#", '#', U238.block());
		addRecipeAuto(new ItemStack(ModItems.ingot_uranium_fuel, 9), "#", '#', ModBlocks.block_uranium_fuel);
		addRecipeAuto(new ItemStack(ModItems.ingot_neptunium, 9), "#", '#', NP237.block());
		addRecipeAuto(new ItemStack(ModItems.ingot_polonium, 9), "#", '#', PO210.block());
		addRecipeAuto(new ItemStack(ModItems.ingot_plutonium, 9), "#", '#', PU.block());
		addRecipeAuto(new ItemStack(ModItems.ingot_pu238, 9), "#", '#', PU238.block());
		addRecipeAuto(new ItemStack(ModItems.ingot_pu239, 9), "#", '#', PU239.block());
		addRecipeAuto(new ItemStack(ModItems.ingot_pu240, 9), "#", '#', PU240.block());
		...
		addRecipeAuto(new ItemStack(ModItems.ingot_solinium, 9), "#", '#', SA327.block());
		addRecipeAuto(new ItemStack(ModItems.ingot_schrabidium_fuel, 9), "#", '#', ModBlocks.block_schrabidium_fuel);
		addRecipeAuto(new ItemStack(ModItems.ammo_4gauge, 12), " I ", "GCL", " P ", 'I', ModItems.pellet_buckshot, 'G', ANY_SMOKELESS.dust(), 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'L', ModItems.plate_polymer);
		addRecipeAuto(new ItemStack(ModItems.ammo_4gauge_slug, 12), " I ", "GCL", " P ", 'I', PB.ingot(), 'G', ANY_SMOKELESS.dust(), 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'L', ModItems.plate_polymer);
		addRecipeAuto(new ItemStack(ModItems.ammo_4gauge_flechette, 12), " I ", "GCL", " P ", 'I', ModItems.pellet_flechette, 'G', ANY_SMOKELESS.dust(), 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'L', ModItems.plate_polymer);
		addRecipeAuto(new ItemStack(ModItems.ammo_4gauge_explosive, 4), " I ", "GCL", " P ", 'I', Blocks.TNT, 'G', ANY_SMOKELESS.dust(), 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'L', ModItems.plate_polymer);
		addRecipeAuto(new ItemStack(ModItems.ammo_4gauge_explosive, 6), " I ", "GCL", " P ", 'I', ANY_PLASTICEXPLOSIVE.ingot(), 'G', ANY_SMOKELESS.dust(), 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'L', ModItems.plate_polymer);
		addRecipeAuto(new ItemStack(ModItems.ammo_4gauge_semtex, 4), " I ", "GCL", " P ", 'I', ModBlocks.det_miner, 'G', ANY_SMOKELESS.dust(), 'C', ModItems.casing_50, 'P', ModItems.primer_50, 'L', ModItems.plate_polymer);
		...
		addRecipeAuto(new ItemStack(ModItems.ingot_phosphorus, 9), "#", '#', P_WHITE.block());
		addRecipeAuto(new ItemStack(ModItems.powder_fire, 9), "#", '#', P_RED.block());
		...
		addRecipeAuto(new ItemStack(ModItems.ingot_asbestos, 9), "#", '#', ASBESTOS.block());
		addRecipeAuto(new ItemStack(ModItems.ingot_fiberglass, 9), "#", '#', FIBER.block());
		addRecipeAuto(new ItemStack(ModItems.ingot_cobalt, 9), "#", '#', CO.block());
		...
		addRecipeAuto(new ItemStack(ModItems.mechanism_special, 1), "PCI", "ISS", "PCI", 'P',ModItems.plate_desh, 'C', ModItems.coil_advanced_alloy, 'I', STAR.ingot(), 'S', ModItems.circuit_targeting_tier3);
		addRecipeAuto(new ItemStack(ModItems.gun_ks23, 1), "PPM", "SWL", 'P', STEEL.plate(), 'M', ModItems.mechanism_rifle_1, 'S', Items.STICK, 'W', ModItems.wire_tungsten, 'L', KEY_LOG);
		addShapelessAuto(new ItemStack(ModItems.gun_sauer, 1), ModItems.ducttape, ModItems.gun_ks23, Blocks.LEVER, ModItems.gun_ks23);
		addRecipeAuto(new ItemStack(ModItems.gun_flamer, 1), "WPP", "SCT", "WMI", 'W', ModItems.wire_gold, 'P', ModItems.pipes_steel, 'S', ModItems.hull_small_steel, 'C', ModItems.coil_tungsten, 'T', ModItems.tank_steel, 'M', ModItems.mechanism_launcher_1, 'I', STEEL.ingot());
		addRecipeAuto(new ItemStack(ModItems.ammo_fuel, 1), " P ", "BDB", " P ", 'P', STEEL.plate(), 'B', ModItems.bolt_tungsten, 'D', new IngredientContainsTag(ItemFluidCanister.getFullCanister(ModForgeFluids.diesel)));
		addRecipeAuto(new ItemStack(ModItems.ammo_fuel_napalm, 1), " P ", "BDB", " P ", 'P', STEEL.plate(), 'B', ModItems.bolt_tungsten, 'D', ModItems.canister_napalm);
		addRecipeAuto(new ItemStack(ModItems.ammo_fuel_phosphorus, 1), "CPC", "CDC", "CPC", 'C', COAL.dust(), 'P', P_WHITE.ingot(), 'D', ModItems.ammo_fuel);
		addRecipeAuto(new ItemStack(ModItems.ammo_fuel_gas, 1), "PDP", "BDB", "PDP", 'P', STEEL.plate(), 'B', ModItems.bolt_tungsten, 'D', ModItems.pellet_gas);
		...
		addRecipeAuto(new ItemStack(ModItems.bj_helmet, 1), "SBS", " C ", " I ", 'S', Items.STRING, 'B', new ItemStack(Blocks.WOOL, 1, 15), 'C', ModItems.circuit_targeting_tier4, 'I', STAR.ingot());
		...
		addRecipeAuto(new ItemStack(ModItems.bj_plate_jetpack, 1), "NFN", "TPT", "ICI", 'N', ModItems.plate_armor_lunar, 'F', ModItems.fins_quad_titanium, 'T', new IngredientContainsTag(ItemFluidTank.getFullTank(ModForgeFluids.xenon)), 'P', ModItems.bj_plate, 'I', ModItems.mp_thruster_10_xenon, 'C', P_RED.crystal());
	...
	public static void reg3(){
		...
		addRecipeAuto(new ItemStack(ModItems.ajr_helmet, 1), "PPC", "PBP", "IXI", 'P', ModItems.plate_armor_ajr, 'C', ModItems.circuit_targeting_tier4, 'I', ANY_PLASTIC.ingot(), 'X', ModItems.gas_mask_m65, 'B', ModItems.alloy_helmet);
		...
		addRecipeAuto(new ItemStack(ModItems.reacher, 1), "BIB", "P P", "B B", 'B', ModItems.bolt_tungsten, 'I', W.ingot(), 'P', ModItems.plate_polymer);
		...
		addRecipeAuto(new ItemStack(ModItems.battery_sc_schrabidium), "NBN", "PCP", "NBN", 'N', ModItems.nugget_unobtainium_greater, 'B', SA326.billet(), 'P', ANY_PLASTIC.ingot(), 'C', ModItems.battery_sc_americium);
		addRecipeAuto(new ItemStack(ModItems.battery_sc_balefire), "NBN", "PCP", "NBN", 'N', ModItems.nugget_radspice, 'B', ModItems.pellet_rtg_balefire, 'P', ANY_PLASTIC.ingot(), 'C', ModItems.battery_sc_schrabidium);
		addRecipeAuto(new ItemStack(ModItems.battery_sc_yharonite), "NBN", "PCP", "NBN", 'N', DNT.nugget(), 'B', ModItems.billet_yharonite, 'P', ANY_PLASTIC.ingot(), 'C', ModItems.battery_sc_balefire);
		...
		addRecipeAuto(new ItemStack(ModBlocks.machine_fraction_tower), "SHS", "SGS", "SHS", 'S', STEEL.plate(), 'H', ModItems.hull_big_steel, 'G', LA.ingot());
		...
		addRecipeAuto(new ItemStack(ModItems.cladding_rubber, 1), "RCR", "CDC", "RCR", 'R', ModItems.plate_polymer, 'C', COAL.dust(), 'D', ModItems.ducttape);
		...
		addRecipeAuto(new ItemStack(ModItems.cladding_iron, 1), "OOO", "PDP", "OOO", 'O', IRON.plate(), 'P', ModItems.plate_polymer, 'D', ModItems.ducttape);
		...
		addRecipeAuto(new ItemStack(ModItems.insert_ghiorsium, 1), "PKP", "KSK", "PKP", 'P', ModItems.ducttape, 'K', GH336.ingot(), 'S', U238.ingot());
		...
		//Servos
		addRecipeAuto(new ItemStack(ModItems.servo_set, 1), "MBM", "PBP", "MBM", 'M', ModItems.motor, 'B', ModItems.bolt_tungsten, 'P', IRON.plate());
		addRecipeAuto(new ItemStack(ModItems.servo_set_desh, 1), "MBM", "PSP", "MBM", 'M', ModItems.motor_desh, 'B', ModItems.bolt_dura_steel, 'P', ALLOY.plate(), 'S', ModItems.servo_set);

		//Helmet Mods
		addRecipeAuto(new ItemStack(ModItems.attachment_mask, 1), "DID", "IGI", " F ", 'D', ModItems.ducttape, 'I', ModItems.plate_polymer, 'G', KEY_ANYPANE, 'F', IRON.plate());
		addRecipeAuto(new ItemStack(ModItems.attachment_mask_mono, 1), " D ", "DID", " F ", 'D', ModItems.ducttape, 'I', ModItems.plate_polymer, 'F', IRON.plate());

		//Boot Mods
		addRecipeAuto(new ItemStack(ModItems.pads_rubber, 1), "P P", "IDI", "P P", 'P', ModItems.plate_polymer, 'I', IRON.plate(), 'D', ModItems.ducttape);
		...
		addRecipeAuto(new ItemStack(ModItems.heart_fab, 1), "GHG", "MCM", "GHG", 'G', PO210.billet(), 'H', ModItems.heart_booster, 'M', ModItems.canteen_fab, 'C', ModItems.coin_worm);
		...
		addShapelessAuto(new ItemStack(ModItems.injector_5htp, 1), ModItems.five_htp, ModItems.circuit_targeting_tier1, BIGMT.plate());
		...
		addRecipeAuto(new ItemStack(ModItems.drax_mk2, 1), "SCS", "IDI", "FEF", 'S', STAR.ingot(), 'C', ModItems.crystal_trixite, 'I', BIGMT.ingot(), 'D', ModItems.drax, 'F', ModItems.fusion_core, 'E', ModItems.circuit_targeting_tier5);
		addRecipeAuto(new ItemStack(ModItems.drax_mk3, 1), "ECE", "CDC", "SBS", 'E', ModBlocks.block_euphemium_cluster, 'C', SA326.crystal(), 'D', ModItems.drax_mk2, 'S', ModItems.circuit_targeting_tier6, 'B', ItemBattery.getFullBattery(ModItems.battery_spark));
		...
		addRecipeAuto(new ItemStack(ModItems.chlorophyte_pickaxe, 1), " SD", "APS", "FA ", 'S', ModItems.blades_steel, 'D', ModItems.powder_chlorophyte, 'A', FIBER.ingot(), 'P', ModItems.bismuth_pickaxe, 'F', ModItems.bolt_dura_steel);
		addRecipeAuto(new ItemStack(ModItems.chlorophyte_pickaxe, 1), " SD", "APS", "FA ", 'S', ModItems.blades_steel, 'D', ModItems.powder_chlorophyte, 'A', FIBER.ingot(), 'P', ModItems.volcanic_pickaxe, 'F', ModItems.bolt_dura_steel);
		addRecipeAuto(new ItemStack(ModItems.bismuth_pickaxe, 1), " BM", "BPB", "TB ", 'B', ANY_BISMOID.ingot(), 'M', ModItems.ingot_meteorite, 'P', ModItems.starmetal_pickaxe, 'T', ModItems.bolt_tungsten);
		addRecipeAuto(new ItemStack(ModItems.volcanic_pickaxe, 1), " BM", "BPB", "TB ", 'B', VOLCANIC.gem(), 'M', ModItems.ingot_meteorite, 'P', ModItems.starmetal_pickaxe, 'T', ModItems.bolt_tungsten);
		...
		addRecipeAuto(new ItemStack(ModItems.upgrade_nullifier, 1), "SPS", "PUP", "SPS", 'S', STEEL.plate(), 'P',P_RED.dust(), 'U', ModItems.upgrade_template);
		...
		addRecipeAuto(new ItemStack(ModItems.upgrade_screm, 1), "SUS", "SCS", "SUS", 'S', STEEL.plate(), 'U', ModItems.upgrade_overdrive_3, 'C', ModItems.crystal_xen);
		

		addRecipeAuto(new ItemStack(ModItems.charge_railgun), "PDP", "DDD", "PDP", 'P', STEEL.plate(), 'D', new IngredientContainsTag(ItemFluidTank.getFullTank(ModForgeFluids.deuterium)));
		...
		addRecipeAuto(new ItemStack(ModItems.hev_battery, 4), " W ", "IEI", "ICI", 'W', ModItems.wire_gold, 'I', ModItems.plate_polymer, 'E', ModItems.powder_power, 'C', CO.dust());
		addRecipeAuto(new ItemStack(ModItems.hev_battery, 4), " W ", "ICI", "IEI", 'W', ModItems.wire_gold, 'I', ModItems.plate_polymer, 'E', ModItems.powder_power, 'C', CO.dust());
		...
		addRecipeAuto(new ItemStack(ModItems.billet_uranium, 2), "ABC", "BB ", "BB ", 'A', U238.billet(), 'B', U238.nugget(), 'C', U235.nugget());
		...
		addShapelessAuto(new ItemStack(ModItems.ingot_thorium_fuel, 3), TH232.ingot(), TH232.ingot(), U233.ingot());
		addShapelessAuto(new ItemStack(ModItems.billet_thorium_fuel, 3), TH232.billet(), TH232.billet(), U233.billet());
		addShapelessAuto(new ItemStack(ModItems.billet_thorium_fuel, 1), TH232.nugget(), TH232.nugget(), TH232.nugget(), TH232.nugget(), U233.nugget(), U233.nugget());
		...
		addShapelessAuto(new ItemStack(ModItems.ingot_uranium_fuel, 6), U238.ingot(), U238.ingot(), U238.ingot(), U238.ingot(), U238.ingot(), U235.ingot());
		addShapelessAuto(new ItemStack(ModItems.billet_uranium_fuel, 6), U238.billet(), U238.billet(), U238.billet(), U238.billet(), U238.billet(), U235.billet());
		addShapelessAuto(new ItemStack(ModItems.billet_uranium_fuel, 1), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U238.nugget(), U235.nugget());
		
		addShapelessAuto(new ItemStack(ModBlocks.block_plutonium_fuel, 3), U238.block(), PURG.block(), PURG.block());
		addShapelessAuto(new ItemStack(ModItems.ingot_plutonium_fuel, 3), U238.ingot(), PURG.ingot(), PURG.ingot());
		addShapelessAuto(new ItemStack(ModItems.billet_plutonium_fuel, 3), U238.billet(), PURG.billet(), PURG.billet());
		addShapelessAuto(new ItemStack(ModItems.billet_plutonium_fuel, 1), PURG.nugget(), PURG.nugget(), PURG.nugget(), PURG.nugget(), U238.nugget(), U238.nugget());
		...
		addShapelessAuto(new ItemStack(ModItems.ingot_mox_fuel, 3), U238.ingot(), U235.ingot(), PURG.ingot());
		addShapelessAuto(new ItemStack(ModItems.billet_mox_fuel, 3), U238.billet(), U235.billet(), PURG.billet());
		addShapelessAuto(new ItemStack(ModItems.billet_mox_fuel, 1), U238.nugget(), U238.nugget(), U235.nugget(), U235.nugget(), PURG.nugget(), PURG.nugget());
		
		addShapelessAuto(new ItemStack(ModItems.billet_les, 54), SA326.block(), NP237.block(), NP237.block(), NP237.block(), NP237.block(), BE.block(), BE.block(), BE.block());
		...
		addShapelessAuto(new ItemStack(ModItems.nugget_les, 9), SA326.nugget(), NP237.nugget(), NP237.nugget(), NP237.nugget(), NP237.nugget(), BE.nugget(), BE.nugget(), BE.nugget());
		...
		addShapelessAuto(new ItemStack(ModItems.billet_hes, 54), SA326.block(), SA326.block(), NP237.block(), BE.block());
		...
		addShapelessAuto(new ItemStack(ModItems.billet_uranium_fuel, 9), U238.ingot(), U238.ingot(), U238.ingot(), U238.ingot(), U238.ingot(), U235.ingot());

		addShapelessAuto(new ItemStack(ModItems.ingot_uranium, 2), U.billet(), U.billet(), U.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_u233, 2), U233.billet(), U233.billet(), U233.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_u235, 2), U235.billet(), U235.billet(), U235.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_u238, 2), U238.billet(), U238.billet(), U238.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_plutonium, 2), PU.billet(), PU.billet(), PU.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_pu238, 2), PU238.billet(), PU238.billet(), PU238.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_pu239, 2), PU239.billet(), PU239.billet(), PU239.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_pu240, 2), PU240.billet(), PU240.billet(), PU240.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_pu241, 2), PU241.billet(), PU241.billet(), PU241.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_pu_mix, 2), PURG.billet(), PURG.billet(), PURG.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_am241, 2), AM241.billet(), AM241.billet(), AM241.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_am242, 2), AM242.billet(), AM242.billet(), AM242.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_am_mix, 2), AMRG.billet(), AMRG.billet(), AMRG.billet());
		...
		addShapelessAuto(new ItemStack(ModItems.ingot_neptunium, 2), NP237.billet(), NP237.billet(), NP237.billet());
		...
		addShapelessAuto(new ItemStack(ModItems.ingot_polonium, 2), PO210.billet(), PO210.billet(), PO210.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_technetium, 2), TC99.billet(),TC99.billet(),TC99.billet());
		addShapelessAuto(new ItemStack(ModItems.nugget_schrabidium, 2), SA326.billet(), SA326.billet(), SA326.billet());
		addShapelessAuto(new ItemStack(ModItems.ingot_solinium, 2), SA327.billet(), SA327.billet(), SA327.billet());
		...
		addShapelessAuto(new ItemStack(ModItems.billet_balefire_gold, 1), AU198.billet(), new IngredientContainsTag(ItemCell.getFullCell(ModForgeFluids.amat)), ModItems.pellet_charged);
		addShapelessAuto(new ItemStack(ModItems.billet_flashlead, 2), ModItems.billet_balefire_gold, PB209.billet(), new IngredientContainsTag(ItemCell.getFullCell(ModForgeFluids.amat)));
		addShapelessAuto(new ItemStack(ModItems.billet_flashlead, 2), AU198.billet(), PB209.billet(), new IngredientContainsTag(ItemCell.getFullCell(ModForgeFluids.amat)), new IngredientContainsTag(ItemCell.getFullCell(ModForgeFluids.amat)), ModItems.pellet_charged);
		...
		addRecipeAuto(new ItemStack(ModItems.assembly_nuke, 1), " WP", "SEP", " WP", 'W', ModItems.wire_aluminium, 'P', STEEL.plate(), 'S', ModItems.hull_small_steel, 'E', ANY_PLASTICEXPLOSIVE.ingot())	;
		...
		if(!GeneralConfig.enable528) {
			...
			addRecipeAuto(new ItemStack(ModBlocks.rbmk_crane_console, 1), "BCN", "DDD", 'B', B.ingot(), 'D', ModBlocks.deco_rbmk, 'C', ModItems.circuit_targeting_tier3, 'N', ModItems.gun_fatman_ammo);
