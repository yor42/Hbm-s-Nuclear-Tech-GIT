...
public class AssemblerRecipes {
	...
	private static void registerDefaults() {
		...
		makeRecipe(new ComparableStack(ModItems.pellet_schrabidium, 1), new AStack[] { new OreDictStack(SA326.ingot(), 5), new OreDictStack(IRON.plate(), 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_hes, 1), new AStack[] { new ComparableStack(ModItems.ingot_hes, 5), new OreDictStack(IRON.plate(), 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_mes, 1), new AStack[] { new ComparableStack(ModItems.ingot_schrabidium_fuel, 5), new OreDictStack(IRON.plate(), 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_les, 1), new AStack[] { new ComparableStack(ModItems.ingot_les, 5), new OreDictStack(IRON.plate(), 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_beryllium, 1), new AStack[] { new OreDictStack(BE.ingot(), 5), new OreDictStack(IRON.plate(), 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_neptunium, 1), new AStack[] { new OreDictStack(NP237.ingot(), 5), new OreDictStack(IRON.plate(), 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_lead, 1), new AStack[] { new OreDictStack(PB.ingot(), 5), new OreDictStack(IRON.plate(), 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		makeRecipe(new ComparableStack(ModItems.pellet_advanced, 1), new AStack[] { new OreDictStack(DESH.ingot(), 5), new OreDictStack(IRON.plate(), 2), new ComparableStack(ModItems.ingot_tennessine, 2), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.upgrade_speed_1, 1), new AStack[] { new ComparableStack(ModItems.upgrade_template, 1), new OreDictStack(MINGRADE.dust(), 4), new ComparableStack(Items.REDSTONE, 6), new ComparableStack(ModItems.wire_red_copper, 4), }, 200);
		...
		makeRecipe(new ComparableStack(ModItems.part_plutonium, 1), new AStack[] { new ComparableStack(ModItems.plate_polymer, 1), new OreDictStack(PU.dust(), 1), }, 50);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_schrabidium_battery, 1), new AStack[] { 
			...
			new ComparableStack(ModItems.wire_schrabidium, 4), }, 800);
		...
		makeRecipe(new ComparableStack(ModItems.mp_warhead_10_taint, 1), new AStack[] { new ComparableStack(ModItems.seg_10, 1), new OreDictStack(STEEL.plate(), 12), new ComparableStack(ModBlocks.det_cord, 2), new ComparableStack(ModItems.powder_magic, 12), new NbtComparableStack(FluidUtil.getFilledBucket(new FluidStack(ModForgeFluids.mud_fluid, 1000))), }, 100);
		...
		makeRecipe(new ComparableStack(ModBlocks.machine_large_turbine, 1), new AStack[] { new ComparableStack(ModItems.hull_big_steel, 1), new OreDictStack(STEEL.plate(), 12), new ComparableStack(ModItems.turbine_titanium, 3), new ComparableStack(ModItems.rotor_steel, 2), new ComparableStack(ModItems.generator_steel, 2), new ComparableStack(ModItems.bolt_compound, 3), new ComparableStack(ModItems.pipes_steel, 1), new ComparableStack(ModItems.circuit_aluminium, 1), }, 20);
		...
		makeRecipe(new ComparableStack(ModItems.pellet_rtg_polonium, 1), new AStack[] { new OreDictStack(PO210.nugget(), 5), new OreDictStack(IRON.plate(), 2), }, 50);
		...
		makeRecipe(new ComparableStack(ModBlocks.small_hatch, 1), new AStack[]{new OreDictStack(PB.plate(), 4), new OreDictStack(STEEL.plate(), 8), new OreDictStack(ALLOY.plate(), 2), new ComparableStack(ModItems.bolt_dura_steel, 1), new ComparableStack(ModBlocks.brick_concrete, 1), new ComparableStack(ModBlocks.ladder_red, 1)}, 200);
		...
		makeRecipe(new ComparableStack(ModBlocks.sliding_seal_door, 1), new AStack[]{new OreDictStack(STEEL.plate(), 6), new OreDictStack(ALLOY.plate(), 2), new ComparableStack(ModItems.plate_polymer, 1), new ComparableStack(ModItems.motor, 1), new ComparableStack(ModItems.bolt_dura_steel, 1), new OreDictStack(KEY_LIGHTGRAY, 1)}, 300);
		...
		makeRecipe(new ComparableStack(ModBlocks.control0, 1), new AStack[]{new ComparableStack(ModItems.circuit_targeting_tier5), new OreDictStack(STEEL.block(), 1), new ComparableStack(ModItems.wire_copper, 24), new ComparableStack(ModBlocks.pole_top)}, 100);
