...
public class GUINukeN2 extends GuiContainer {
	...
	private static final ResourceLocation texture = new ResourceLocation(RefStrings.MODID + ":textures/gui/n2Schematic.png");
	private final TileEntityNukeN2 testNuke;
