...
public class GUIReactorControl extends GuiInfoContainer {
	...
	protected void mouseClicked(int x, int y, int i) throws IOException {
    	...
    	if(guiLeft + 7 <= x && guiLeft + 7 + 18 > x && guiTop + 16 < y && guiTop + 16 + 18 >= y) {
    		...
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), control.isOn ? 0 : 1, 0));
    	}
		
    	if(guiLeft + 43 <= x && guiLeft + 43 + 18 > x && guiTop + 16 < y && guiTop + 16 + 18 >= y) {
    		
			mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), control.auto ? 0 : 1, 1));
    	}
		
    	if(guiLeft + 63 <= x && guiLeft + 63 + 14 > x && guiTop + 52 < y && guiTop + 52 + 18 >= y) {
    		
			mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), (control.compression + 1) % 3, 2));
    	}
    }
	...
	protected void drawGuiContainerForegroundLayer( int i, int j) {
		...
		this.fontRenderer.drawString("Rods: " + control.rods + "%", 8, 40, 4210752);
	}
    ...
    protected void keyTyped(char ch, int i) throws IOException
    {
        ...
        case '0':
			mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 0, 0)); break;
        case '1':
			mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 10, 0)); break;
        case '2':
			mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 20, 0)); break;
        case '3':
			mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 30, 0)); break;
        case '4':
			mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 40, 0)); break;
        case '5':
			mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 50, 0)); break;
        case '6':
			mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 60, 0)); break;
        case '7':
			mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 70, 0)); break;
        case '8':
			mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 80, 0)); break;
        case '9':
			mc.getSoundHandler().playSound(PositionedSoundRecord.getMasterRecord(SoundEvents.UI_BUTTON_CLICK, 1.0F));
    		PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), 90, 0)); break;
        }
    ...
    public void handleMouseInput() throws IOException
    {
        ...
        if(i != 0) {
			...
			PacketDispatcher.wrapper.sendToServer(new AuxButtonPacket(control.getPos().getX(), control.getPos().getY(), control.getPos().getZ(), rods, 0));
        }
    }
}
